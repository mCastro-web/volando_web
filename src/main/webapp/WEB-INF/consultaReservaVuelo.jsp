...
<body class="bg-base-200 min-h-screen flex flex-col">
    ...
    <select id="selAero" name="aerolinea" class="select select-bordered w-full">
        ...
        %>
            <option value="<%= a %>" <%= a.equals(request.getAttribute("aerolineaSeleccionada")) ? "selected" : "" %>><%= a %></option>
        <%
                }
                   } else {
    %>
...
%>
    ...
    <%
        // Solo mostramos los pasajes si hay una reserva seleccionada
        if (reservaSeleccionada != null) {
    %>
...
<!-- Paso 6: Listado de pasajes de la reserva seleccionada -->
<%
    // Solo mostramos los pasajes si hay una reserva seleccionada
    if (reservaSeleccionada2 != null) {
%>
...
%>
   ...
   <% } %>
    ...
    <script src="${pageContext.request.contextPath}/js/consultaReservaVuelo.js"></script>
  </form>
</body>
</html>